   ...
   /*  public function store(Request $request)
    ...
    public function insertData(Request $request)
    {
        ...
        if (Track::create($input)) {
            $response = ['msg' => 'Track Added Successfully'];
        } else {
            $response = ['msg' => 'Track Addition Failed'];
        }
    ...
    public function editData(Request $request,$id)
    {
        ...
        if ($product->update($input)) {
            $response = ['msg' => 'Track Updated Successfully'];
        } else {
            $response = ['msg' => 'Track Update Failed'];
        }
        return response()->json($response);
    }
    ...
    public function Destroy(Request $request)
    {
        ...
        if ($product) {
            $product->delete();
            $response = ['msg' => 'Track deleted successfully'];
        } else {
            $response = ['msg' => 'Track not found'];
        }
